...
<head>
	 <meta charset="UTF-8">
	 <title>Verwijder leverancier</title>
...
<body>
    <?php
        ...
        if (!isset($_POST["submt-sel-supp-del"]) )
        {
...
//        include "header.php";
   ...
   ?>
    <main class="centering">
        <h2 class="spacebelowabove">Verwijderen leverancier</h2>
        <form action="sup-crud-delete.php" method="post" class="tabledisp">
            ...
            <fieldset class="tbodyflex">
                ...
                <input type="text" name="supp_company" readonly value="<?php echo $dataSupplier["company"]; ?>" >
            </fieldset>
            <fieldset class="tbodyflex">
                <label for="supp_streetaddress">Adres leverancier : </label>
                <input type="text" name="supp_streetaddress" readonly value="<?php echo $dataSupplier["adress"]; ?>" >
            </fieldset>
            <fieldset class="tbodyflex">
                <label for="supp_streetnr">Adres leverancier : </label>
                <input type="text" name="supp_streetnr" readonly value="<?php echo $dataSupplier["streetnr"]; ?>" >
            </fieldset>
            <fieldset class="tbodyflex">
            ...
            <fieldset class="tbodyflex">
                ...
                <input type="text" name="supp_city" readonly value="<?php echo $dataSupplier["city"]; ?>" >
            </fieldset>
            <fieldset class="tbodyflex">
                <label for="supp_state">Provincie : </label>
                <input type="text" name="supp_state" readonly value="<?php echo $dataSupplier["state"]; ?>" >
            </fieldset>
            <fieldset class="tbodyflex">
                <label for="supp_country">Land : </label>
                <input type="number" name="supp_country" readonly value="<?php echo $dataSupplier["countryid"]; ?>" >
            </fieldset>
            <fieldset class="tbodyflex">
                <label for="supp_teleph">Telefoon : </label>
                <input type="text" name="supp_teleph" readonly value="<?php echo $dataSupplier["telephone"]; ?>" >
            </fieldset>
            <fieldset class="tbodyflex">
                <label for="supp_domain">Website : </label>
                <textarea rows="10" cols="50" name="supp_domain" readonly><?php echo $dataSupplier["website"]; ?></textarea>
            </fieldset>
        ...
        Bij het openen van het programma is het aanleverende programma vastgelegd in variabele $return_prog -->
            <fieldset class="tbodyflex, spacebelowabove">
                ...
                <input type="submit" value="Verwijder" name="supp_applydelete">
            </fieldset>
        </form>
    </main>
